...
const passwords = [
  { account: "Gmail", password: "r@hul$h@rm@90", source: "HiTeckGroop.in", risk: "Critical" as const },
  { account: "Gmail", password: "Rahul@2024!", source: "Alien TxtBase", risk: "High" as const },
  { account: "Banking Portal", password: "Fin@nce#2023", source: "DarkForums Dump", risk: "Critical" as const },
  { account: "Social Media", password: "Social@Pass1", source: "BreachDB", risk: "Medium" as const },
  { account: "Shopping Site", password: "Shop@2024#R", source: "InfoStealer Collection", risk: "High" as const },
  { account: "Work Email", password: "T3chC0rp@W0rk", source: "Alien TxtBase", risk: "High" as const },
  { account: "Cloud Storage", password: "Cl0ud#Acc3ss", source: "DarkForums Dump", risk: "Critical" as const },
  { account: "Payment App", password: "P@y••••••", source: "InfoStealer Collection", risk: "High" as const },
];
